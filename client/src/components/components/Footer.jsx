  ...
  <Row className="g-4">
    <Col lg={3}>
      <Link className="me-0" to="/">
        <img className="light-mode-item h-40px" width={189} height={40} src={logo} alt="Kattraan Logo" />
        <img className="dark-mode-item h-40px" width={189} height={40} src={logoLight} alt="Kattraan Logo" />
      </Link>
      <p className="my-3">
    ...
    <Col lg={3}>
      <h5 className="mb-2 mb-md-4">Contact Us</h5>
      <p className="mb-2">
        Support: <span className="h6 fw-light ms-2">+91 98765 43210</span>
        <span className="d-block small">(Available 9 AM – 8 PM IST)</span>
      </p>
      <p className="mb-0">
        Email: <span className="h6 fw-light ms-2">support@kattraan.com</span>
      </p>
      <Row className="g-2 mt-2">
        <Col xs={6} sm={4} md={3} lg={6}>
          <span role="button">
            <img height={45} width={145} className="w-auto" src={googlePlay} alt="Download on Google Play" />
          </span>
        </Col>
        <Col xs={6} sm={4} md={3} lg={6}>
          <span role="button">
            <img height={45} width={145} className="w-auto" src={playStore} alt="Download on App Store" />
          </span>
        </Col>
      </Row>
    </Col>
    ...
    <Container className="px-0">
      <div className="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
        <div className="text-body text-primary-hover">
          &copy; {currentYear} Kattraan. Built by  
