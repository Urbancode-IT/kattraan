...
import element7 from '@/assets/images/element/hero-final.png';
      ...
      <Container>
        <Row className="align-items-center g-5">
          <Col lg={5} xl={6} className="position-relative z-index-1 text-center text-lg-start mb-7 mb-sm-0">
            ...
            Unlock Your Potential with Kattraan – Learn, Grow, Succeed!
            ...
            Kattraan is your gateway to limitless learning. Explore expert-led courses, earn certifications, and upskill for success in today's digital world.
            </p>
          ...
          <Col lg={7} xl={6} className="text-center position-relative">
            ...
            <div className="position-relative ms-sm-4">
               <img src={element7} alt="element-image" style={{ height: "90vh", width: "auto" }} />
            </div>
          </Col>
        </Row>
      </Container>
